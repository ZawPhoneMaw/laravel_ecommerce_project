		...
		<div align="center" style="margin-top: 40px;"> 
					...
					@foreach($product as $product)
						<tr class="paddinglabel">
							...
							<td><img src="/product/{{$product->image}}" width="300px" height="300px"></td>
							<td><a href="{{url('/product_delete', $product->id)}}" onclick="return confirm('Are You sure to delete?')" class="btn btn-danger">Delete</a></td>
							<td><a href="{{url('/product_update', $product->id)}}" class="btn btn-primary">Update</a></td>
						</tr>
					@endforeach
					</table>
